...
import { IDatabaseInterface, ISession, PasswordVerifier } from 'thomasio-auth-js-common/lib/server';
...
export class SqliteDatabaseInterface<I, P> implements IDatabaseInterface<I> {
	...
	private passwordVerifier: PasswordVerifier<P>;
	...
	constructor(
		...
		passwordVerifier: PasswordVerifier<P>,
